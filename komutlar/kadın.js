...
const kadın = message.guild.roles.cache.find(r => r.id === '790861621554839580')
const kadın2 = message.guild.roles.cache.find(r => r.id === '790861621529411622')
...
let kadındata = datab.fetch(`yetkili.${message.author.id}.kadin`)

const rol = "790861621554839580";
...
:christmas_tree: ${kadın} & ${kadın2} rolleri Verilip ${kayıtsız} rolü alındı.
...
:christmas_tree: Yetkilinin toplam ${alldata} kayıtı & ${kadındata} erkek kayıtı var.
