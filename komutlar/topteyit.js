...
if(!message.member.roles.cache.some(r => ['790861621685256212', '790861621648031771'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.channel.send("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
